...
// Run the sweep and surface a notice to the admin if items were
// automatically returned to the storefront.
$expired_count = run_reservation_expiry($conn);
...
<div class="container-fluid px-4 pb-5">
    ...
    <div class="d-flex justify-content-between align-items-center mt-4 mb-4">
        <div>
            <h3 class="fw-bold text-dark mb-0">
                <i class="fa-solid fa-store me-2 text-primary"></i> Storefront Management
            </h3>
    ...
    <?php if ($expired_count > 0): ?>
        <div class="alert border-0 shadow-sm rounded-3 alert-dismissible fade show"
             style="background:#fff7ed; border-left: 4px solid #f97316 !important;">
            <div class="d-flex align-items-center gap-2">
                <i class="fa-solid fa-rotate-left text-warning fs-5"></i>
                <div>
                    <strong class="text-dark">Auto-forfeiture ran:</strong>
                    <span class="text-muted">
                        <?php echo $expired_count; ?> reservation(s) exceeded the 3-day payment deadline.
                        Downpayments were forfeited and the item(s) have been returned to the storefront
                        as <strong>Available</strong>.
                    </span>
                </div>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0 custom-table">
                    <thead class="bg-light text-muted small text-uppercase"
                           style="border-bottom: 2px solid #f1f2f4;">
                        <tr>
                                    ...
                                    <td class="ps-4 py-3">
                                        ...
                                        <small class="text-muted">
                                            ...
                                            <span class="badge bg-light border text-dark ms-1">
                                                PT#<?php echo $row['pt_number']; ?>
                                            </span>
                                        </small>
                                    </td>
                                    <td class="py-3">
                                        <small class="text-muted">
                                            <?php echo date('M d, Y', strtotime($row['date_published'])); ?>
                                        </small>
                                    </td>
                                    ...
                                    <td class="text-end pe-4 py-3">
                                        ...
                                        <?php if ($row['shop_status'] === 'available'): ?>
                                            <div class="btn-group shadow-sm rounded-pill overflow-hidden">
                                                <button class="btn btn-sm btn-light border-end text-primary fw-bold px-3"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#editModal<?php echo $row['shop_id']; ?>"
                                                        title="Edit Price">
                                                    <i class="fa-solid fa-pen me-1"></i> Edit
                                                </button>
                                                <button class="btn btn-sm btn-light text-danger fw-bold px-3"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#removeModal<?php echo $row['shop_id']; ?>"
                                        ...
                                        <div class="modal-content border-0 shadow rounded-4">
                                            <div class="modal-header border-0 bg-light">
                                                <h5 class="modal-title fw-bold text-dark">
                                                    <i class="fa-solid fa-pen-to-square me-2 text-primary"></i> Edit Selling Price
                                                </h5>
                                                ...
                                                <div class="modal-body p-4 text-start">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="input-group input-group-lg">
                                                            ...
                                                            <input type="number" name="new_price" class="form-control fw-bold"
                                        ...
                                        <div class="modal-content border-0 shadow rounded-4">
                                            <div class="modal-header border-0 bg-danger text-white">
                                                <h5 class="modal-title fw-bold">
                                                    <i class="fa-solid fa-triangle-exclamation me-2"></i> Remove Item
                                                </h5>
                                            ...
                                            <form method="POST">
                                                <div class="modal-body p-4 text-center">
                                                    ...
                                                    <small class="text-muted mt-2 d-block">
                                                        This item will be returned to the <strong>Ready for Sale</strong> list.
                                                    </small>
                                                </div>
                                                <div class="modal-footer border-0 bg-light d-flex justify-content-center">
                                                    ...
                                                    <button type="submit" name="btn_remove_item"
                                                            class="btn btn-danger fw-bold px-4">Yes, Remove it</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                            ...
                            <tr>
                                <td colspan="5" class="text-center py-5">
                                    <div class="empty-state d-flex flex-column align-items-center justify-content-center py-4">
                                        <div class="bg-light rounded-circle d-flex align-items-center justify-content-center mb-3 text-muted"
