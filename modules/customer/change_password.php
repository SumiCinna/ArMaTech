<?php
// modules/customer/change_password.php
session_start();
require_once '../../config/database.php';

// SECURITY: Ensure the customer is logged in
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['btn_update_password'])) {
    ...
    if (empty($current_password) || empty($new_password) || empty($confirm_password)) {
        ...
        // Fetch the customer's current hashed password from the database
...
// Include the customer header AFTER processing so alerts render correctly
...
<style>
    ...
    .form-control:focus { box-shadow: 0 0 0 4px rgba(13, 110, 253, 0.1) !important; border-color: var(--fintech-primary) !important; background-color: #fff !important; }
    ...
    <div class="row justify-content-center">
        <div class="col-lg-6 col-md-8">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h3 class="fw-bold mb-0 text-dark"><i class="fa-solid fa-shield-halved me-2 text-primary"></i> Security Settings</h3>
            </div>
            ...
            <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                ...
                <div class="card-body p-4 pt-0">
                    <form action="change_password.php" method="POST" class="needs-validation" novalidate>
                        ...
                        <button type="submit" name="btn_update_password" class="btn btn-primary w-100 btn-lg rounded-pill shadow fw-bold py-3">
